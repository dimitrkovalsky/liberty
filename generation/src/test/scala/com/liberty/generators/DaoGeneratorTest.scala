...
class DaoGeneratorTest {
  ...
  @Test def generateTwoMongoDao() {
    ...
    Assert.assertEquals("WEB-INF files should not be created", Nil, generator.createWebInfFiles)
  }
  ...
  @Test def generateTwoPostgresDao() {
    ...
    entities.foreach(e => Assert.assertTrue(e.toString.equals(expected1) || e.toString.equals(expected2)))
    ...
    generator.createWebInfFiles match {
